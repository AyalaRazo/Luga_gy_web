...
export default function AcceptInvite() {
  ...
  const inp = 'w-full px-4 py-3 font-poppins text-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500 border border-pink-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-400 transition-all';
  ...
  if (!hasSession) {
    return (
      <div className="min-h-screen bg-pink-50 dark:bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-pink-100 dark:border-gray-700 p-8 max-w-sm w-full text-center">
          <div className="w-14 h-14 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
            <AlertCircle size={24} className="text-red-500" />
          </div>
          <h1 className="font-poppins text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">Link inválido o expirado</h1>
          <p className="font-poppins text-sm text-gray-500 dark:text-gray-400 mb-5">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-pink-100 dark:border-gray-700 p-8 max-w-sm w-full">
        ...
        {done ? (
          <div className="text-center py-4">
            ...
            <p className="font-poppins text-sm font-semibold text-gray-800 dark:text-gray-100">¡Contraseña establecida!</p>
            <p className="font-poppins text-xs text-gray-400 dark:text-gray-500 mt-1">Redirigiendo al panel…</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="flex items-center gap-2 bg-red-50 dark:bg-red-900/20 border border-red-200 rounded-xl px-3 py-2">
            ...
            <div>
              <label className="block font-poppins text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1.5 uppercase tracking-wide">
                Nueva contraseña
              </label>
