...
const gallery = [
  ...
  { id: 3, category: 'brows', description: 'Diseño y laminado de cejas', emoji: '✨' },
  ...
  >
    ...
    >
      ...
      <div className="flex">
        ...
        {/* After */}
        <div className={`w-1/2 h-64 bg-gradient-to-br ${categoryColors[item.category] || 'from-pink-200 to-pink-400'} flex items-center justify-center`}>
          <div className="text-center">
